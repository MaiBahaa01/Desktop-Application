...
namespace Design
{
    ...
    public partial class Report_Customer : Form
    {
        ...
        private void getDataBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                // Git All Customer 
                Grid1.DataSource = context.Customers.Select(c => new { c.ID, c.Name, c.Phone, c.Address, c.Email , c.Orders }).ToList();
                check = true;
            }
        ...
        private void printBtn_Click(object sender, EventArgs e)
        {
            ...
            if (check)
            {
                ...
                Report_Customer_View printForm = new Report_Customer_View();
            ...
            {
                MessageBox.Show("Please Get Customers First");
            }
